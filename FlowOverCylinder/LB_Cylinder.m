...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Modified by Hongyang Zhou, hyzhou@umich.edu 14/04/2019
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
obst_x = nx/5+1;   % position of the cylinder; (exact
obst_y = ny/2+3;   % y-symmetry is avoided)
obst_r = ny/10+1;  % radius of the cylinder
...
[y,x] = meshgrid(1:ny,1:nx); % get coordinate of matrix indices
