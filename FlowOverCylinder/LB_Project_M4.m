...
% populations
nPreInitStep = 0;
Nx = 200;   % # of Cells in x-direction
Ny = 100;   % # of Cells in y-direction
...
%% Storage Parameters
nOut = 50; % Amount of timepoints at which values are recorded
...
cs   = 1/sqrt(3);
U    = 0.1;
Re   = 50; % Reynolds number of the cyclinder
visc = 2.*U*R/Re;
tau  = visc/cs^2;
beta = 1/(2*tau+1);
